    ...
    <svg viewBox="0 0 309 278">
      ...
      <g className={styles.cls1}>
        <g id="Shard_5" data-name="Shard 5">
          <polygon fill={edgesColor} filter={browserNotSupported ? '' : "url(#filter-crystal2)"}
        ...
        <g id="Sheens">
          <polyline className={styles.cls8} points="112.25 84.92 199.29 84.28 137.9 88.31" />
          <polygon className={styles.cls8} points="103.44 168.84 167.03 118.11 114.58 165.12 103.44 168.84" />
        </g>
      </g>
    </svg>
  )
