    ...
    <svg viewBox='0 0 414 317'>
          ...
          <g className='cls-10'>
            <g transform='translate(9.03 24.91)'>
              <image
                width='241'
                height='146'
                transform='translate(87.97 51.09)'
      ...
      <g className={styles.cls1}>
        <g id='Shard_6' data-name='Shard 6'>
          <polygon
            fill={edgesColor}
            filter={browserNotSupported ? '' : 'url(#filter-crystal11)'}
        ...
        <g id='Sheens'>
          <polygon
            ...
            points='296.81 91.65 292.29 114.66 314.79 140.83 295.71 114.21 296.81 91.65'
          />
          <polygon
            className={styles.cls8}
            points='331.51 123.68 320.98 137.25 329.73 130.85 331.51 123.68'
          />
          <polygon
            className={styles.cls8}
            points='299.95 83.06 327.24 118.52 301.18 91.22 299.95 83.06'
          />
          <g id='Layer_21' data-name='Layer 21'>
            <polygon
              className={styles.cls8}
              points='316.44 144.19 318.76 164.26 320.98 157.64 316.44 144.19'
            />
            <polygon
              className={styles.cls8}
              points='286.98 117.53 109.86 191.76 154.56 180.76 286.98 117.53'
            />
            <polygon
              className={styles.cls8}
              points='126.28 212.63 280.07 165.7 313.6 163.53 126.28 212.63'
            />
          </g>
        </g>
      </g>
