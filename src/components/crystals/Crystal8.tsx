    ...
    <svg viewBox="0 0 332 348">
      ...
      <g className={styles.cls1}>
        <g id="Shard_13" data-name="Shard 13">
          ...
          <g onClick={onClickHandler} className={styles.cls5crystal8}>
        ...
        <g id="Sheens">
          <polygon className={styles.cls8} points="206.56 155.52 196.54 158.98 203.1 159.93 206.56 155.52" />
          <polygon className={styles.cls8} points="158.98 174.6 161.84 169.35 173.29 169.83 158.98 174.6" />
          <polygon className={styles.cls8} points="185.88 152.44 110.8 89.21 160.25 155.99 185.88 152.44" />
          <polygon className={styles.cls8} points="239.78 233.5 211.99 182.3 185.88 178.86 239.78 233.5" />
        </g>
      </g>
    </svg >
  )
