    ...
    <svg viewBox='0 0 278 300'>
          ...
          <g className={styles.cls9}>
            <g transform='translate(-0.52 5.91)'>
              <image
                width='105'
                height='128'
                transform='translate(97.52 70.09)'
      ...
      <g className={styles.cls1}>
        <g id='Shard_11' data-name='Shard 11'>
          <polygon
            fill={edgesColor}
            filter={browserNotSupported ? '' : 'url(#filter-crystal10)'}
        ...
        <g id='Sheens'>
          <polygon
            ...
            points='192.15 85.23 143.98 165.33 136.79 165.33 155.2 175.53 192.15 85.23'
          />
          <polygon
            className={styles.cls8}
            points='177.39 93.67 108.41 150.85 123 155.47 177.39 93.67'
          />
          <polygon
            className={styles.cls8}
            points='119.62 194.31 122.81 161.5 105.99 154.44 119.62 194.31'
          />
          <polygon
            className={styles.cls8}
            points='126.74 189.95 128.04 168.45 154.15 181.89 126.74 189.95'
          />
        </g>
      </g>
    </svg>
